            ...
            if ([forTopStories isEqualToNumber:[NSNumber numberWithInt:0]]) {
                ...
                if(isDailyDigestClick) {
                    ...
                    if([self.reportTypeId isEqualToNumber:[NSNumber numberWithInt:1]]) {
                        //Trend of coverage
                        [[FISharedResources sharedResourceManager]getTrendOfCoverageArticleListFromDate:self.clickedDate endDateIn:self.trendOfCoverageEndDateIn fromDate:self.reportFromDate toDate:self.reportToDate withModules:self.reportModules withTags:self.reportTags withSize:[NSNumber numberWithInteger:10] withPageNo:[NSNumber numberWithInteger:pageNo] withFilterBy:filterString withQuery:self.searchText withFlag:@"" withLastArticleId:[self.articleIdArray lastObject]];
                    } else if([self.reportTypeId isEqualToNumber:[NSNumber numberWithInt:2]]) {
                        [[FISharedResources sharedResourceManager]getKeyTopicsArticleListFromField1:@"fields.name" value1:self.keyTopicsBrandName fromDate:self.reportFromDate toDate:self.reportToDate withModules:self.reportModules withTags:self.reportTags withSize:[NSNumber numberWithInt:10] withPageNo:[NSNumber numberWithInteger:pageNo] withFilterBy:filterString withQuery:self.searchText withFlag:@"" withLastArticleId:[self.articleIdArray lastObject]];
                    } else if([self.reportTypeId isEqualToNumber:[NSNumber numberWithInt:3]]) {
                        //Media types
                        [[FISharedResources sharedResourceManager]getMediaTypesArticleListFromMediaTypeField:@"mediaTypeId" mediaTypeValue:self.mediaTypesBrandName fromDate:self.reportFromDate toDate:self.reportToDate withModules:self.reportModules withTags:self.reportTags withSize:[NSNumber numberWithInt:10] withPageNo:[NSNumber numberWithInteger:pageNo] withFilterBy:filterString withQuery:self.searchText withFlag:@"" withLastArticleId:[self.articleIdArray lastObject]];
                    } else if([self.reportTypeId isEqualToNumber:[NSNumber numberWithInt:4]]) {
                        //sentiment and volume over time
                        [[FISharedResources sharedResourceManager]getSentimentOverTimeArticleListFromDate:self.clickedDate endDateIn:@"MONTH" field1:@"tonality.name" field2:@"fields.name" value1:self.sentimentChartTonalityValue value2:self.sentimentChartSelectedName fromDate:self.reportFromDate toDate:self.reportToDate withModules:self.reportModules withTags:self.reportTags withSize:[NSNumber numberWithInt:10] withPageNo:[NSNumber numberWithInteger:pageNo] withFilterBy:filterString withQuery:self.searchText withFlag:@"" withLastArticleId:[self.articleIdArray lastObject]];
                    ...
                    if([folderId isEqualToNumber:[NSNumber numberWithInt:0]] && [newsLetterId isEqualToNumber:[NSNumber numberWithInt:0]]) {
                        if([category isEqualToNumber:[NSNumber numberWithInt:-2]]) {
                            ...
                            NSString *queryString;
                            if (self.isSearching) {
                                queryString = [FIUtils formArticleListInuptFromSecurityToken:[[NSUserDefaults standardUserDefaults] objectForKey:@"accesstoken"] withContentTypeId:[NSNumber numberWithInt:1] withPageNumber:[NSNumber numberWithInteger:pageNo] withSize:[NSNumber numberWithInt:10] withQuery:self.searchText withContentCategoryId:[NSNumber numberWithInt:-1] withOrderBy:@"" withFilterBy:@"" withActivityTypeID:[NSNumber numberWithInt:3] withCompanyId:self.companyIdInDetailPage];
                            } else if (self.switchForFilter == 1){
                                queryString = [FIUtils formArticleListInuptFromSecurityToken:[[NSUserDefaults standardUserDefaults] objectForKey:@"accesstoken"] withContentTypeId:[NSNumber numberWithInt:1] withPageNumber:[NSNumber numberWithInteger:pageNo] withSize:[NSNumber numberWithInt:10] withQuery:@"" withContentCategoryId:[NSNumber numberWithInt:-1] withOrderBy:@"" withFilterBy:@"UNREAD" withActivityTypeID:[NSNumber numberWithInt:2] withCompanyId:self.companyIdInDetailPage];
